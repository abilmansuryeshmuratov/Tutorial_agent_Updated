[@elizaos/core v0.1.9](../index.md) / formatEvaluatorExamples
...
[packages/core/src/evaluators.ts:55](https://github.com/abilmansuryeshmuratov/tutorial_agent/blob/main/packages/core/src/evaluators.ts#L55)
